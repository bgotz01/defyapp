...
// Modified createTokenMetadata without Group address
export const createTokenMetadata = (authority: PublicKey, mint: PublicKey, name: string, symbol: string, uri: string): TokenMetadata => {
    const tokenMetadata: TokenMetadata = {
        ...
        symbol: symbol,
        uri: uri,
        additionalMetadata: [], // No Group address here
    };
