//src/app/register/designerRegister/page.tsx
...
const DesignerRegister = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4000/api/registerDesigner', {
        username,
        password,
        email,
        solanaWallet,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-white dark:bg-customGrey p-8 rounded shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-black dark:text-white">Register as Designer</h2>
